...
class MainActivity : AppCompatActivity() {
    ...
    private fun calculation() {
        ...
        try {
            if(name == null || weight == null || height == null || age == null || name.text.length > 50 || height.text.toString().toInt() !in 1..249 || weight.text.toString().toDouble() !in 1.0..249.0 || age.text.toString().toInt() !in 1..149){
